...
export class EventsService {
  ...
  private async getHolidayEvents(month: number, year: number, familyId: string): Promise<any[]> {
    const solarHolidays = [
      ...
      { day: 20, month: 3, title: '😊 Ngày Quốc tế Hạnh phúc' },
      { day: 26, month: 3, title: '🛡️ Ngày Thành lập Đoàn' },
      { day: 1, month: 4, title: '🤡 Ngày Cá tháng Tư (April Fools’ Day)' },
      { day: 22, month: 4, title: '🌍 Ngày Trái Đất (Earth Day)' },
      ...
      { day: 31, month: 10, title: '🎃 Halloween' },
      { day: 19, month: 11, title: '👨 Ngày Quốc tế Nam giới' },
    ...
    const lunarHolidays = [
      ...
      { day: 7, month: 7, title: '💞 Thất Tịch (Ngưu Lang - Chức Nữ)' },
